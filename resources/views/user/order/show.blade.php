        ...
        <div class="row">
          <div class="col-12">
            <div class="order-products">
              ...
              @if($order->cart_info && count($order->cart_info) > 0)
                <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>
                        @if($cart->product_photo)
                          <img src="{{ $cart->product_photo }}" alt="{{ $cart->product_name ?? 'Product' }}" style="max-width: 80px; max-height: 80px; object-fit: cover;">
                        @else
                          <span class="text-muted">No image</span>
                        @endif
                      </td>
                      <td>{{ $cart->product_name ?? 'Product name not available' }}</td>
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td><strong>${{ $order->shipping ? $order->shipping->price : '0' }}</strong></td>
                    </tr>
                    <tr>
